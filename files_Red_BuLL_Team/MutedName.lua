...
database:sadd(bot_id.."Red_BuLL_Team:blocname"..msg.chat_id_, BlNe)
end
...
database:srem(bot_id.."Red_BuLL_Team:blocname"..msg.chat_id_, delBn)
end

if text == "مسح الاسماء المكتومه" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
database:del(bot_id.."Red_BuLL_Team:blocname"..msg.chat_id_)
...
local All_name = database:smembers(bot_id.."Red_BuLL_Team:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."Red_BuLL_Team:blocname"..msg.chat_id_) or ""
